...
public enum Message {
    ...
    SENDER__CLAIM_TICKET,
    SENDER__UNCLAIM_TICKET,
    ...
    // notification
    NOTIFY__CLAIM_TICKET,
    NOTIFY__UNCLAIM_TICKET,
    ...
    ANNOUNCEMENT__CLAIM_TICKET,
    ANNOUNCEMENT__UNCLAIM_TICKET,
    ...
    SHOW__LOCATION,
    // exceptions
    EXCEPTION__NO_PERMISSION,
    EXCEPTION__INVALID_SENDER,
